...
const settingsNav = [
  { name: 'Profile', href: '/dashboard/recruiter/settings/profile', icon: User },
  { name: 'Security', href: '/dashboard/recruiter/settings/security', icon: Lock },
  { name: 'Account', href: '/dashboard/recruiter/settings/account', icon: CreditCard },
];
