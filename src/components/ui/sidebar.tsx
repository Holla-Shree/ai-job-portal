      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex h-full w-full has-[[data-variant=inset]]:bg-background",
              className
            )}
            ref={ref}
            {...props}
      ...
      >
        ...
        <div
          className={cn(
            ...
            side === "left"
              ? "left-0 top-16 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
              : "right-0 top-16 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex h-full flex-1 flex-col bg-background overflow-auto",
