      ...
      >
        ...
        <div
          className={cn(
            ...
            side === "left"
              ? "left-0 top-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
              : "right-0 top-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
